...
public class DarkRed {
    ...
    public static boolean checkReqs(User user) {
        if (!user.hasRunePermission("darkred")) {
    ...
    public static void execute(User user) {
        ...
        int x = random.nextInt(RuneConfigs.darkredmax);
        int z = random.nextInt(RuneConfigs.darkredmax);
        int y = 70;
